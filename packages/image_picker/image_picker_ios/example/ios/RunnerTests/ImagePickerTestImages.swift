...
/// Provides access to the bundle containing the test resources.
enum ImagePickerTestBundle {
...
/// Image data for the test images that are used by multiple test suites.
enum ImagePickerTestImages {
  static var jpgTestData: Data {
    data(forResource: "jpgImage", withExtension: "jpg", base64Fallback: jpgBase64)
  }

  static var jpgTallTestData: Data {
    data(forResource: "jpgImageTall", withExtension: "jpg", base64Fallback: jpgTallBase64)
  }

  static var pngTestData: Data {
    data(forResource: "pngImage", withExtension: "png", base64Fallback: pngBase64)
  }

  static var gifTestData: Data {
    data(forResource: "gifImage", withExtension: "gif", base64Fallback: gifBase64)
  }
  ...
  private static func data(
    ...
    if let url = ImagePickerTestBundle.bundle.url(
    ...
    // embedded in the test bundle. Fall back to the base64 string representation of the image.
    return Data(base64Encoded: base64Fallback) ?? Data()
  }

  private static let jpgBase64 = [
  ...
  private static let jpgTallBase64 = [
