...
struct MediaSelectionOptions: Hashable {
  ...
  static func == (lhs: MediaSelectionOptions, rhs: MediaSelectionOptions) -> Bool {
    ...
    return deepEqualsmessages(lhs.maxSize, rhs.maxSize)
      && deepEqualsmessages(lhs.imageQuality, rhs.imageQuality)
      && deepEqualsmessages(lhs.requestFullMetadata, rhs.requestFullMetadata)
      && deepEqualsmessages(lhs.allowMultiple, rhs.allowMultiple)
      && deepEqualsmessages(lhs.limit, rhs.limit)
  }
